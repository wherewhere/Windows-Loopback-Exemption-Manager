...
namespace CommunityToolkit.WinUI.Controls
{
    ...
    public class DataGridTextColumn : DataGridBoundColumn
    {
        ...
        /// <summary>
        /// Gets a <see cref="TextBox"/> control that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.
        /// </summary>
        /// <param name="cell">The cell that will contain the generated element.</param>
        /// <param name="dataItem">The data item represented by the row that contains the intended cell.</param>
        /// <returns>A new <see cref="TextBox"/> control that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.</returns>
        ...
        /// <summary>
        /// Gets a read-only <see cref="TextBlock"/> element that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.
        /// </summary>
        /// <param name="cell">The cell that will contain the generated element.</param>
        /// <param name="dataItem">The data item represented by the row that contains the intended cell.</param>
        /// <returns>A new, read-only <see cref="TextBlock"/> element that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.</returns>
        ...
        protected internal override void RefreshCellContent(FrameworkElement element, Brush computedRowForeground, string propertyName)
        {
            ...
            if (textBox == null)
            {
                TextBlock textBlock = element as TextBlock ?? throw DataGridError.DataGrid.ValueIsNotAnInstanceOfEitherOr("element", typeof(TextBox), typeof(TextBlock));
            ...
            {
                SetTextFontSize(textBox, Control.FontSizeProperty);
            }
            else if (propertyName == DATAGRIDTEXTCOLUMN_fontStyleName)
            {
