...
namespace CommunityToolkit.WinUI.Controls
{
    ...
    public class DataGridTemplateColumn : DataGridColumn
    {
        ...
        internal bool HasDistinctTemplates => CellTemplate != CellEditingTemplate;
        ...
        /// <summary>
        /// Gets an element defined by the <see cref="P:CommunityToolkit.WinUI.Controls.DataGridTemplateColumn.CellEditingTemplate"/> that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.
        /// </summary>
        /// <returns>A new editing element that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.</returns>
        /// <param name="cell">The cell that will contain the generated element.</param>
        /// <param name="dataItem">The data item represented by the row that contains the intended cell.</param>
        /// <exception cref="T:System.TypeInitializationException">
        /// The <see cref="P:CommunityToolkit.WinUI.Controls.DataGridTemplateColumn.CellEditingTemplate"/> is null.
        /// </exception>
        ...
        /// <summary>
        /// Gets an element defined by the <see cref="P:CommunityToolkit.WinUI.Controls.DataGridTemplateColumn.CellTemplate"/> that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.
        /// </summary>
        /// <returns>A new, read-only element that is bound to the column's <see cref="P:CommunityToolkit.WinUI.Controls.DataGridBoundColumn.Binding"/> property value.</returns>
        /// <param name="cell">The cell that will contain the generated element.</param>
        /// <param name="dataItem">The data item represented by the row that contains the intended cell.</param>
        /// <exception cref="T:System.TypeInitializationException">
        /// The <see cref="P:CommunityToolkit.WinUI.Controls.DataGridTemplateColumn.CellTemplate"/> is null.
        /// </exception>
