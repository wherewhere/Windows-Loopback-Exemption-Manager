...
namespace CommunityToolkit.WinUI.Controls
{
    ...
    [TemplatePart(Name = DATAGRID_elementValidationSummary, Type = typeof(ValidationSummary))]
#endif
    [TemplatePart(Name = DATAGRID_elementRowsPresenterName, Type = typeof(DataGridRowsPresenter))]
    [TemplatePart(Name = DATAGRID_elementColumnHeadersPresenterName, Type = typeof(DataGridColumnHeadersPresenter))]
    [TemplatePart(Name = DATAGRID_elementFrozenColumnScrollBarSpacerName, Type = typeof(FrameworkElement))]
    [TemplatePart(Name = DATAGRID_elementHorizontalScrollBarName, Type = typeof(ScrollBar))]
    [TemplatePart(Name = DATAGRID_elementVerticalScrollBarName, Type = typeof(ScrollBar))]
    ...
    public partial class DataGrid : Control
    {
        ...
        private readonly ObservableCollection<Style> _rowGroupHeaderStyles;
        ...
        private readonly Dictionary<IObservableVector<object>, WeakEventListener<DataGrid, object, IVectorChangedEventArgs>> _groupsVectorChangedListenersTable = [];
#endif
        ...
        /// <summary>
        /// Occurs when the <see cref="CommunityToolkit.WinUI.Controls.DataGridColumn.DisplayIndex"/>
        ...
        /// <summary>
        /// Occurs when the <see cref="CommunityToolkit.WinUI.Controls.DataGridColumn"/> sorting request is triggered.
        /// </summary>
        ...
        public DataGrid()
        {
            ...
            LastHandledKeyDown = VirtualKey.None;
        ...
        {
            get => GetValue(AlternatingRowBackgroundProperty) as Brush;
        ...
        {
            get => GetValue(AlternatingRowForegroundProperty) as Brush;
        ...
        {
            get => (bool)GetValue(AreRowGroupHeadersFrozenProperty);
        ...
        {
            get => GetValue(CellStyleProperty) as Style;
        ...
        {
            get => GetValue(ColumnHeaderStyleProperty) as Style;
        ...
        private static void OnFrozenColumnCountPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!dataGrid.IsHandlerSuspended(e.Property))
            {
                if ((int)e.NewValue < 0)
                {
                    dataGrid.SetValueNoCallback(FrozenColumnCountProperty, e.OldValue);
        ...
        private static void OnHeadersVisibilityPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            static bool hasFlags(DataGridHeadersVisibility value, DataGridHeadersVisibility flags) => ((value & flags) == flags);
            ...
            {
                foreach (FrameworkElement element in dataGrid._rowsPresenter.Children.OfType<FrameworkElement>())
                {
        ...
        {
            get => GetValue(HorizontalGridLinesBrushProperty) as Brush;
        ...
        private static void OnItemsSourcePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!dataGrid.IsHandlerSuspended(e.Property))
            {
                ...
                if (newItemsSource != null && newItemsSource is not ICollectionView)
                {
                ...
                if (dataGrid.DataConnection.DataSource != null)
                {
                    ...
                    {
                        foreach (DataGridBoundColumn boundColumn in dataGrid.ColumnsInternal.GetDisplayedColumns(column => column is DataGridBoundColumn).OfType<DataGridBoundColumn>())
                        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="Brush"/> that is used as the default cells foreground.
        /// </summary>
        public Brush RowForeground
        {
            get => GetValue(RowForegroundProperty) as Brush;
        ...
        {
            get => GetValue(RowHeaderStyleProperty) as Style;
        ...
        private static void OnSelectedItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!dataGrid.IsHandlerSuspended(e.Property))
            {
                ...
                else
                {
                    ...
                    {
                        dataGrid.SetValueNoCallback(SelectedIndexProperty, rowIndex);
                    }
                    ...
                    {
                        dataGrid.SetValueNoCallback(SelectedIndexProperty, oldSelectedIndex);
                        d.SetValueNoCallback(e.Property, e.OldValue);
                    }
                }
            }
        ...
        /// <summary>
        /// Gets or sets the <see cref="Brush"/> that is used to paint grid lines separating columns.
        /// </summary>
        public Brush VerticalGridLinesBrush
        {
            get => GetValue(VerticalGridLinesBrushProperty) as Brush;
        ...
        public DataGridColumn CurrentColumn
        {
            get
            {
                ...
                DiagnosticsDebug.Assert(CurrentColumnIndex < ColumnsItemsInternal.Count, "Expected CurrentColumnIndex smaller than ColumnsItemsInternal.Count.");
                return ColumnsItemsInternal[CurrentColumnIndex];
            }

            set
            {
                DataGridColumn dataGridColumn = value ?? throw DataGridError.DataGrid.ValueCannotBeSetToNull("value", "CurrentColumn");
        ...
        {
            get => _rowGroupHeaderPropertyNameAlternative;
            set => _rowGroupHeaderPropertyNameAlternative = value;
        }

        /// <summary>
        /// Gets the style that is used when rendering the row group header.
        /// </summary>
        public ObservableCollection<Style> RowGroupHeaderStyles => _rowGroupHeaderStyles;
        ...
        protected object CurrentItem
        {
            get
            {
                if (CurrentSlot == -1 ||
                    ...
                    ItemsSource /*DataConnection.DataSource*/ == null)
                {
                    return null;
                }
        ...
        internal double ActualRowHeaderWidth => !AreRowHeadersVisible ? 0 : !double.IsNaN(RowHeaderWidth) ? RowHeaderWidth : RowHeadersDesiredWidth;

        internal double ActualRowsPresenterHeight => _rowsPresenter != null ? _rowsPresenter.ActualHeight : 0;

        internal bool AllowsManipulation => _rowsPresenter != null &&
        ...
        internal bool AutoSizingColumns
        {
            ...
            set
            {
                if (_autoSizingColumns && value == false && ColumnsInternal != null)
                {
        ...
        internal double CellsHeight => RowsPresenterAvailableSize.HasValue ? RowsPresenterAvailableSize.Value.Height : 0;
        ...
        internal bool ColumnHeaderHasFocus
        {
            ...
            set
            {
                DiagnosticsDebug.Assert(!value || (ColumnHeaders != null && AreColumnHeadersVisible), "Expected value==False || (non-null ColumnHeaders and AreColumnHeadersVisible==True)");

                if (_columnHeaderHasFocus != value)
                {
                    _columnHeaderHasFocus = value;

                    if (CurrentColumn != null && IsSlotVisible(CurrentSlot))
                    {
                        UpdateCurrentState(DisplayData.GetDisplayedElement(CurrentSlot), CurrentColumnIndex, true /*applyCellState*/);
                    }

                    DataGridColumn oldFocusedColumn = FocusedColumn;
                    FocusedColumn = null;

                    if (_columnHeaderHasFocus)
                    {
                        FocusedColumn = CurrentColumn ?? ColumnsInternal.FirstVisibleNonFillerColumn;
                    }
                    ...
                    if (FocusedColumn != null && FocusedColumn.HasHeaderCell)
                    {
                        FocusedColumn.HeaderCell.ApplyState(true);
                        ScrollColumnIntoView(FocusedColumn.Index);
                    }
                }
            }
        }

        internal DataGridColumnHeaderInteractionInfo ColumnHeaderInteractionInfo { get; set; }
        ...
        internal int EditingColumnIndex => _editingColumnIndex;
        ...
        internal DataGridColumn FocusedColumn { get; set; }

        internal bool HasColumnUserInteraction => ColumnHeaderInteractionInfo.HasUserInteraction;
            ...
            set
            {
                ...
                if (_rowHeaderDesiredWidth < value)
                {
                    ...
                    if (oldActualRowHeaderWidth != ActualRowHeaderWidth)
                    {
                        ...
                        if (!invalidated && ColumnsInternal.VisibleStarColumnCount > 0)
                        {
                            ColumnsInternal.EnsureVisibleEdgedColumnsWidth();
                            InvalidateMeasure();
                        }
        ...
        internal bool UpdatedStateOnTapped { get; set; }
        ...
        private bool AreAllScrollBarsCollapsed => (_hScrollBar == null || _hScrollBar.Visibility == Visibility.Collapsed) &&
                       (_vScrollBar == null || _vScrollBar.Visibility == Visibility.Collapsed);

        private bool AreBothScrollBarsVisible => _hScrollBar != null && _hScrollBar.Visibility == Visibility.Visible &&
                       _vScrollBar != null && _vScrollBar.Visibility == Visibility.Visible;

        private DataGridCellCoordinates CurrentCellCoordinates
        {
            get => _currentCellCoordinates;
            set => _currentCellCoordinates = value;
        }
        ...
        {
            get => _isHorizontalScrollBarInteracting;
        ...
        {
            get => _isVerticalScrollBarInteracting;
        ...
        private VirtualKey LastHandledKeyDown { get; set; }
        ...
        public bool BeginEdit(RoutedEventArgs editingEventArgs)
        {
            ...
            DiagnosticsDebug.Assert(CurrentColumnIndex >= 0, "Expected positive CurrentColumnIndex.");
            DiagnosticsDebug.Assert(CurrentColumnIndex < ColumnsItemsInternal.Count, "Expected CurrentColumnIndex smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(CurrentSlot >= -1, "Expected CurrentSlot greater than or equal to -1.");
            DiagnosticsDebug.Assert(CurrentSlot < SlotCount, "Expected CurrentSlot smaller than SlotCount.");
            DiagnosticsDebug.Assert(EditingRow == null || EditingRow.Slot == CurrentSlot, "Expected null EditingRow or EditingRow.Slot equal to CurrentSlot.");
        ...
        {
            return CancelEdit(editingUnit, true /*raiseEvents*/);
        }
        ...
        public void ScrollIntoView(object item, DataGridColumn column)
        {
            ...
            if (item == null)
            {
                ...
                ScrollSlotIntoView(column.Index, DisplayData.FirstScrollingSlot, false /*forCurrentCellChange*/, true /*forceHorizontalScroll*/);
            }
            else
            {
                int slot;
                ...
                else
                {
                    ...
                    if (rowIndex == -1 || (IsReadOnly && rowIndex == DataConnection.NewItemPlaceholderIndex))
                    {
                        return;
                    }
        ...
        /// <see cref="DataGridRow.ArrangeOverride(Size)"/> pass.
        /// </summary>
        /// <returns>
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_columnHeadersPresenter != null)
            {
                ...
                List<DataGridColumn> sortedInternal = [.. ColumnsItemsInternal];
        ...
        protected virtual void OnCellEditEnded(DataGridCellEditEndedEventArgs e)
        {
            ...
            DataGridAutomationPeer peer = FrameworkElementAutomationPeer.FromElement(this) as DataGridAutomationPeer;
        ...
        protected override void OnPointerWheelChanged(PointerRoutedEventArgs e)
        {
            ...
            if (!e.Handled)
            {
                ...
                if ((isForHorizontalScroll && HorizontalScrollBarVisibility == ScrollBarVisibility.Disabled) ||
                    (!isForHorizontalScroll && VerticalScrollBarVisibility == ScrollBarVisibility.Disabled))
                {
                    return;
                }
        ...
        internal void InitializeElements(bool recycleRows)
        {
            try
            {
                ...
                List<object> selectedItemsCache = [.. _selectedItems.SelectedItemsCache];
        ...
        internal bool ProcessScrollOffsetDelta(double offsetDelta, bool isForHorizontalScroll)
        {
            if (IsEnabled && DisplayData.NumDisplayedScrollingElements > 0)
            {
                ...
                {
                    double newHorizontalOffset = HorizontalOffset + offsetDelta;
                    if (newHorizontalOffset < 0)
                    {
                        newHorizontalOffset = 0;
                    }

                    double maxHorizontalOffset = Math.Max(0, ColumnsInternal.VisibleEdgedColumnsWidth - CellsWidth);
        ...
        {
            DataGridColumnHeaderInteractionInfo interactionInfo = ColumnHeaderInteractionInfo;
        ...
        internal bool ScrollSlotIntoView(int columnIndex, int slot, bool forCurrentCellChange, bool forceHorizontalScroll)
        {
            ...
            DiagnosticsDebug.Assert(columnIndex < ColumnsItemsInternal.Count, "Expected columnIndex smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(DisplayData.FirstDisplayedScrollingCol >= -1, "Expected DisplayData.FirstDisplayedScrollingCol greater than or equal to -1.");
            DiagnosticsDebug.Assert(DisplayData.FirstDisplayedScrollingCol < ColumnsItemsInternal.Count, "Expected smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(DisplayData.LastTotallyDisplayedScrollingCol >= -1, "Expected DisplayData.LastTotallyDisplayedScrollingCol greater than or equal to -1.");
            DiagnosticsDebug.Assert(DisplayData.LastTotallyDisplayedScrollingCol < ColumnsItemsInternal.Count, "Expected DisplayData.LastTotallyDisplayedScrollingCol smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(!IsSlotOutOfBounds(slot), "Expected IsSlotOutOfBounds(slot) is false.");
            DiagnosticsDebug.Assert(DisplayData.FirstScrollingSlot >= -1, "Expected DisplayData.FirstScrollingSlot greater than or equal to -1.");
            DiagnosticsDebug.Assert(DisplayData.FirstScrollingSlot < SlotCount, "Expected DisplayData.FirstScrollingSlot smaller than SlotCount.");
            DiagnosticsDebug.Assert(ColumnsItemsInternal[columnIndex].IsVisible, "Expected ColumnsItemsInternal[columnIndex].IsVisible is true.");
            ...
            bool rowGroupHeadersTableContainsSlot = RowGroupHeadersTable.Contains(slot);
        ...
        internal void UpdateStateOnCurrentChanged(object currentItem, int currentPosition)
        {
            if ((currentItem == CurrentItem) &&
                (_isUserSorting || (currentItem == SelectedItem && currentPosition == SelectedIndex)))
            {
            ...
            if (columnIndex == -1)
            {
                ...
                else if (ColumnsInternal.RowGroupSpacerColumn.IsRepresented && _desiredCurrentColumnIndex == ColumnsInternal.RowGroupSpacerColumn.Index)
                {
                    columnIndex = FirstDisplayedNonFillerColumnIndex;
                }
                else
        ...
        internal void UpdateVerticalScrollBar()
        {
            if (_vScrollBar != null && _vScrollBar.Visibility == Visibility.Visible)
            {
                ...
                UpdateVerticalScrollBar(
                    ...
                    VerticalScrollBarVisibility == ScrollBarVisibility.Visible /*forceVertScrollBar*/,
        ...
        internal bool WaitForLostFocus(Action action)
        {
            if (EditingRow != null && EditingColumnIndex != -1 && !_executingLostFocusActions)
            {
                ...
                FrameworkElement editingElement = editingColumn.GetCellContent(EditingRow);
        ...
        {
#if FEATURE_IEDITABLECOLLECTIONVIEW
            if (DataConnection.EditableCollectionView != null && DataConnection.EditableCollectionView.CanAddNew)
            {
                _desiredCurrentColumnIndex = CurrentColumnIndex;
                object addItem = DataConnection.EditableCollectionView.AddNew();
                if (CurrentItem != DataConnection.EditableCollectionView.CurrentAddItem)
                {
                    int newItemSlot = SlotFromRowIndex(DataConnection.IndexOf(addItem));
                    SetAndSelectCurrentCell(CurrentColumnIndex, newItemSlot, true);
        ...
        private bool BeginCellEdit(RoutedEventArgs editingEventArgs)
        {
            ...
            DiagnosticsDebug.Assert(CurrentSlot < SlotCount, "Expected CurrentSlot smaller than SlotCount.");
            DiagnosticsDebug.Assert(EditingRow == null || EditingRow.Slot == CurrentSlot, "Expected null EditingRow or EditingRow.Slot equal to CurrentSlot.");
            DiagnosticsDebug.Assert(!GetColumnEffectiveReadOnlyState(CurrentColumn), "Expected GetColumnEffectiveReadOnlyState(CurrentColumn) is false.");
            DiagnosticsDebug.Assert(CurrentColumn.IsVisible, "Expected CurrentColumn.IsVisible is true.");

            if (_editingColumnIndex != -1)
            {
                // Current cell is already in edit mode
                DiagnosticsDebug.Assert(_editingColumnIndex == CurrentColumnIndex, "Expected _editingColumnIndex equals CurrentColumnIndex.");
                return true;
            }
            ...
            if (dataGridRow == null)
            {
                DiagnosticsDebug.Assert(!RowGroupHeadersTable.Contains(CurrentSlot), "Expected CurrentSlot not contained in RowGroupHeadersTable.");
            ...
            EditingRow.Cells[CurrentColumnIndex].ApplyCellState(true /*animate*/);
        ...
        {
            DiagnosticsDebug.Assert(EditingRow == null, "Expected non-null EditingRow.");
            DiagnosticsDebug.Assert(dataGridRow != null, "Expected non-null dataGridRow.");
        ...
        private bool CancelRowEdit(bool exitEditingMode)
        {
            ...
            DiagnosticsDebug.Assert(EditingRow != null, "Expected non-null EditingRow.");
            DiagnosticsDebug.Assert(EditingRow.Index >= -1, "Expected EditingRow greater or equal to -1.");
            DiagnosticsDebug.Assert(EditingRow.Slot < SlotCount, "Expected EditingRow smaller than SlotCount.");
            DiagnosticsDebug.Assert(CurrentColumn != null, "Expected non-null CurrentColumn.");
            ...
            foreach (DataGridColumn column in Columns)
            {
                ...
                PopulateCellContent(!exitEditingMode && column.Index == _editingColumnIndex /*isCellEdited*/, column, EditingRow, EditingRow.Cells[column.Index]);
            }
        ...
        private bool CommitRowEdit(bool exitEditingMode)
        {
            ...
            DiagnosticsDebug.Assert(EditingRow != null, "Expected non-null EditingRow.");
            DiagnosticsDebug.Assert(EditingRow.Index >= -1, "Expected EditingRow.Index greater than or equal to -1.");
            DiagnosticsDebug.Assert(EditingRow.Slot < SlotCount, "Expected EditingRow.Slot smaller than SlotCount.");
        ...
        private void EnsureRowsPresenterVisibility()
        {
            if (_rowsPresenter != null)
            {
                ...
                _rowsPresenter.Visibility = ColumnsInternal.FirstVisibleNonFillerColumn == null ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        private void EnsureTopLeftCornerHeader()
        {
            ...
            {
                _topLeftCornerHeader.Visibility = HeadersVisibility == DataGridHeadersVisibility.All ? Visibility.Visible : Visibility.Collapsed;
        ...
        {
            DiagnosticsDebug.Assert(_validationSummary != null);
            if (EditingRow == null || IsSlotOutOfBounds(EditingRow.Slot) || EditingRow.Slot == -1 || !ScrollSlotIntoView(EditingRow.Slot, false /*scrolledHorizontally*/))
            {
                return;
            }

            // We need to focus the DataGrid in case the focused element gets removed when we end edit.
            if ((_editingColumnIndex == -1 || (Focus(FocusState.Programmatic) && EndCellEdit(DataGridEditAction.Commit, true, true, true)))
                && e.Item != null && e.Target != null && _validationSummary.Errors.Contains(e.Item))
            {
                ...
                {
                    DiagnosticsDebug.Assert(cell.ColumnIndex >= 0 && cell.ColumnIndex < ColumnsInternal.Count);

                    // Begin editing the next relevant cell
                    UpdateSelectionAndCurrency(cell.ColumnIndex, EditingRow.Slot, DataGridSelectionAction.None, true /*scrollIntoView*/);
                    if (_successfullyUpdatedSelection)
                    {
                        BeginCellEdit(new RoutedEventArgs());
        ...
        private void ExpandRowGroupParentChain(int level, int slot)
        {
            ...
            {
                DataGridRowGroupInfo rowGroupInfo = RowGroupHeadersTable.GetValueAt(previousHeaderSlot);
                DiagnosticsDebug.Assert(rowGroupInfo != null, "Expected non-null rowGroupInfo.");
        ...
        private void DataGrid_GotFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (e.OriginalSource as DataGrid == this && AutomationPeer.ListenerExists(AutomationEvents.AutomationFocusChanged))
            {
                DataGridAutomationPeer peer = FrameworkElementAutomationPeer.FromElement(this) as DataGridAutomationPeer;
        ...
        private void DataGrid_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            if (!e.Handled)
            {
                ...
                LastHandledKeyDown = e.Handled ? e.Key : VirtualKey.None;
            }
        }

        private void DataGrid_KeyUp(object sender, KeyRoutedEventArgs e)
        {
            if (e.Key == VirtualKey.Tab && e.OriginalSource as DataGrid == this)
            {
                if (CurrentColumnIndex == -1)
                {
                    if (ColumnHeaders != null && AreColumnHeadersVisible && !ColumnHeaderHasFocus)
                    {
                ...
                {
                    if (ColumnHeaders != null && AreColumnHeadersVisible)
                    {
                        KeyboardHelper.GetMetaKeyState(out _, out var shift);

                        if (shift && LastHandledKeyDown != VirtualKey.Tab)
                        {
                            DiagnosticsDebug.Assert(!ColumnHeaderHasFocus, "Expected ColumnHeaderHasFocus is false.");
                    ...
                    bool success = ScrollSlotIntoView(CurrentColumnIndex, CurrentSlot, false /*forCurrentCellChange*/, true /*forceHorizontalScroll*/);
        ...
        private void DataGrid_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (ContainsFocus)
            {
                ...
                if (focusLeftDataGrid && !(editingColumn is DataGridTemplateColumn))
                {
                    ...
                    else if (CurrentColumnIndex != -1 && IsSlotVisible(CurrentSlot))
                    {
                        UpdateCurrentState(DisplayData.GetDisplayedElement(CurrentSlot), CurrentColumnIndex, true /*applyCellState*/);
                    }
                }
        ...
        {
            if (CurrentColumnIndex != -1 && CurrentSlot != -1)
            {
                e.Handled = true;
            }
        }
        ...
        private bool EndCellEdit(DataGridEditAction editAction, bool exitEditingMode, bool keepFocus, bool raiseEvents)
        {
            ...
            DiagnosticsDebug.Assert(EditingRow != null, "Expected non-null EditingRow.");
            DiagnosticsDebug.Assert(EditingRow.Slot == CurrentSlot, "Expected EditingRow.Slot equals CurrentSlot.");
            DiagnosticsDebug.Assert(_editingColumnIndex >= 0, "Expected positive _editingColumnIndex.");
            DiagnosticsDebug.Assert(_editingColumnIndex < ColumnsItemsInternal.Count, "Expected _editingColumnIndex smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(_editingColumnIndex == CurrentColumnIndex, "Expected _editingColumnIndex equals CurrentColumnIndex.");
            ...
            if (raiseEvents)
            {
                DataGridCellEditEndingEventArgs e = new(CurrentColumn, EditingRow, editingElement, editAction);
                OnCellEditEnding(e);
                if (e.Cancel)
                {
            ...
            if (exitEditingMode)
            {
                ...
                // TODO: Figure out if we should restore a cached IsTabStop.
                IsTabStop = true;
        ...
        private bool EndRowEdit(DataGridEditAction editAction, bool exitEditingMode, bool raiseEvents)
        {
            ...
            if (EditingRow == null || DataConnection.EndingEdit)
            {
                return true;
            }

            if (_editingColumnIndex != -1 || (editAction == DataGridEditAction.Cancel && raiseEvents &&
                !(DataConnection.CanCancelEdit || EditingRow.DataContext is IEditableObject || DataConnection.IsAddingNew)))
            {
            ...
            if (raiseEvents)
            {
                DataGridRowEditEndingEventArgs e = new(EditingRow, editAction);
                OnRowEditEnding(e);
                if (e.Cancel)
                {
            ...
            if (CurrentSlot == -1 && DataConnection.CollectionView != null && DataConnection.CollectionView.CurrentItem != null)
            {
        ...
        private void EnsureColumnHeadersVisibility()
        {
            if (_columnHeadersPresenter != null)
            {
                _columnHeadersPresenter.Visibility = AreColumnHeadersVisible ? Visibility.Visible : Visibility.Collapsed;
            }
        }
        ...
        private void EnsureVerticalGridLines()
        {
            if (AreColumnHeadersVisible)
            {
                ...
                foreach (DataGridColumn column in ColumnsInternal)
                {
                    ...
                    column.HeaderCell.SeparatorVisibility = (column != ColumnsInternal.LastVisibleColumn || totalColumnsWidth < CellsWidth) ?
                        Visibility.Visible : Visibility.Collapsed;
                }
            }
        ...
        private void ExitEdit(bool keepFocus)
        {
            ...
            if (_editingColumnIndex != -1)
            {
                ...
                _editingColumnIndex = -1;
                EditingRow.Cells[CurrentColumnIndex].ApplyCellState(false /*animate*/);
            }
        ...
        private void FlushCurrentCellChanged()
        {
            ...
            if (_collapsedSlotsTable.Contains(CurrentSlot) && CurrentSlot != SlotFromRowIndex(DataConnection.NewItemPlaceholderIndex))
            {
            ...
            if (peer != null && CurrentCellCoordinates != _previousAutomationFocusCoordinates)
            {
                ...
                object focusedObject = GetFocusedElement();
                if (focusedObject as DataGrid == this && AutomationPeer.ListenerExists(AutomationEvents.AutomationFocusChanged))
                {
                    peer.RaiseAutomationFocusChangedEvent(CurrentSlot, CurrentColumnIndex);
                }
            }
        ...
        private bool FocusEditingCell(bool setFocus)
        {
            ...
            // TODO: Figure out if we should cache IsTabStop in order to restore
        ...
        private static string FormatClipboardContent(DataGridRowClipboardEventArgs e)
        {
        ...
        {
            IsEnabledChanged += new DependencyPropertyChangedEventHandler(DataGrid_IsEnabledChanged);
            KeyDown += new KeyEventHandler(DataGrid_KeyDown);
            KeyUp += new KeyEventHandler(DataGrid_KeyUp);
            GettingFocus += new TypedEventHandler<UIElement, GettingFocusEventArgs>(DataGrid_GettingFocus);
            GotFocus += new RoutedEventHandler(DataGrid_GotFocus);
            LostFocus += new RoutedEventHandler(DataGrid_LostFocus);
            PointerEntered += new PointerEventHandler(DataGrid_PointerEntered);
            PointerExited += new PointerEventHandler(DataGrid_PointerExited);
            PointerMoved += new PointerEventHandler(DataGrid_PointerMoved);
            PointerPressed += new PointerEventHandler(DataGrid_PointerPressed);
            PointerReleased += new PointerEventHandler(DataGrid_PointerReleased);
            ...
            DataGridCell dataGridCell)
        {
            ...
            else
            {
                ...
                if (EditingRow != null && dataGridCell.Content != null)
                {
        ...
        private void PreparingCellForEditPrivate(FrameworkElement editingElement)
        {
            if (_editingColumnIndex == -1 ||
                CurrentColumnIndex == -1 ||
                EditingRow.Cells[CurrentColumnIndex].Content as FrameworkElement != editingElement)
            {
            ...
            FocusEditingCell(ContainsFocus || _focusEditingControl /*setFocus*/);
        ...
        private bool ProcessDownKeyInternal(bool shift, bool ctrl)
        {
            ...
            try
            {
                ...
                if (ColumnHeaderHasFocus)
                {
                    ...
                    DiagnosticsDebug.Assert(CurrentColumnIndex != -1, "Expected CurrentColumnIndex other than -1.");
        ...
        private bool ProcessEndKey(bool shift, bool ctrl)
        {
            ...
            if (lastVisibleColumnIndex == -1 || (firstVisibleSlot == -1 && !ColumnHeaderHasFocus))
            {
                return false;
            }
        ...
        private bool ProcessEnterKey(bool shift, bool ctrl)
        {
            ...
            if (!ctrl)
            {
                if (ColumnHeaderHasFocus)
                {
                    CurrentColumn.HeaderCell.InvokeProcessSort();
                    return true;
                }
                else if (FirstVisibleSlot != -1 && RowGroupHeadersTable.Contains(CurrentSlot) && ToggleRowGroup())
                {
                    return true;
                }
            ...
            if (oldCurrentSlot == CurrentSlot && EndCellEdit(DataGridEditAction.Commit, true /*exitEditingMode*/, true /*keepFocus*/, true /*raiseEvents*/) && EditingRow != null)
            {
                EndRowEdit(DataGridEditAction.Commit, true /*exitEditingMode*/, true /*raiseEvents*/);
        ...
        private bool ProcessHomeKey(bool shift, bool ctrl)
        {
            ...
            int firstVisibleColumnIndex = (dataGridColumn == null) ? -1 : dataGridColumn.Index;
            int firstVisibleSlot = FirstVisibleSlot;
            if (firstVisibleColumnIndex == -1 || (firstVisibleSlot == -1 && !ColumnHeaderHasFocus))
            {
                return false;
            }
        ...
        private bool ProcessLeftKey(bool shift, bool ctrl)
        {
            ...
            try
            {
                ...
                else if (firstVisibleSlot != -1 && (!RowGroupHeadersTable.Contains(CurrentSlot) || ColumnHeaderHasFocus))
                {
                    if (CurrentColumnIndex == -1)
                    {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            UpdateSelectionAndCurrency(previousVisibleColumnIndex, CurrentSlot, DataGridSelectionAction.None, true /*scrollIntoView*/);
                        }
                        finally
                        {
                            _noFocusedColumnChangeCount--;
            ...
            if (ColumnHeaderHasFocus)
            {
                ...
                {
                    dataGridColumn = ColumnsInternal.GetPreviousVisibleNonFillerColumn(FocusedColumn);
                    if (dataGridColumn != null)
                    {
                        FocusedColumn = dataGridColumn;
                    }
                }
                else
                {
                ...
                if (firstVisibleSlot == -1 && FocusedColumn != null)
                {
                    ScrollColumnIntoView(FocusedColumn.Index);
                }
            }

            bool focusedColumnChanged = ColumnHeaderHasFocus && oldFocusedColumn != FocusedColumn;
        ...
        private bool ProcessRightKey(bool shift, bool ctrl)
        {
            ...
            if (WaitForLostFocus(() => { ProcessRightKey(shift, ctrl); }))
            {
                return true;
            }
            ...
            try
            {
                ...
                else if (firstVisibleSlot != -1 && (!RowGroupHeadersTable.Contains(CurrentSlot) || ColumnHeaderHasFocus))
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            UpdateSelectionAndCurrency(nextVisibleColumnIndex, CurrentSlot, DataGridSelectionAction.None, true /*scrollIntoView*/);
                        }
                        finally
                        {
                            _noFocusedColumnChangeCount--;
            ...
            if (ColumnHeaderHasFocus)
            {
                if (CurrentColumn == null)
                {
                    dataGridColumn = ColumnsInternal.GetNextVisibleColumn(FocusedColumn);
                    if (dataGridColumn != null)
                    {
                        FocusedColumn = dataGridColumn;
                    }
        ...
        private bool ProcessTabKey(KeyRoutedEventArgs e, bool shift, bool ctrl)
        {
            if (ctrl || _editingColumnIndex == -1 || IsReadOnly)
            {
                ...
                if (!shift && ColumnHeaders != null && AreColumnHeadersVisible && !ColumnHeaderHasFocus)
                {
                    // Show focus on the current column's header.
                    ColumnHeaderHasFocus = true;
                    return true;
                }
                else if (shift && ColumnHeaderHasFocus)
                {
                    ColumnHeaderHasFocus = false;
            ...
            DiagnosticsDebug.Assert(CurrentColumnIndex != -1, "Expected CurrentColumnIndex other than -1.");
            DiagnosticsDebug.Assert(CurrentSlot != -1, "Expected CurrentSlot other than -1.");
            ...
            try
            {
                if (neighborVisibleWritableColumnIndex == -1)
                {
                    ...
                    if (shift)
                    {
                        DiagnosticsDebug.Assert(ColumnsInternal.LastVisibleWritableColumn != null, "Expected non-null ColumnsInternal.LastVisibleWritableColumn.");
                        targetColumnIndex = ColumnsInternal.LastVisibleWritableColumn.Index;
                    }
                    else
                    {
                        DiagnosticsDebug.Assert(ColumnsInternal.FirstVisibleWritableColumn != null, "Expected non-null ColumnsInternal.FirstVisibleWritableColumn.");
        ...
        {
            DataGridRow oldEditingRow = EditingRow;
        ...
        private bool SetCurrentCellCore(int columnIndex, int slot, bool commitEdit, bool endRowEdit)
        {
            DiagnosticsDebug.Assert(columnIndex < ColumnsItemsInternal.Count, "Expected columnIndex smaller than ColumnsItemsInternal.Count.");
            DiagnosticsDebug.Assert(slot < SlotCount, "Expected slot smaller than SlotCount.");
            DiagnosticsDebug.Assert(columnIndex == -1 || ColumnsItemsInternal[columnIndex].IsVisible, "Expected columnIndex equals -1 or ColumnsItemsInternal[columnIndex].IsVisible is true.");
            DiagnosticsDebug.Assert(columnIndex <= -1 || slot != -1, "Expected columnIndex smaller than or equal to -1 or slot other than -1.");

            if (columnIndex == CurrentColumnIndex &&
                slot == CurrentSlot)
            {
                DiagnosticsDebug.Assert(DataConnection != null, "Expected non-null DataConnection.");
                DiagnosticsDebug.Assert(_editingColumnIndex == -1 || _editingColumnIndex == CurrentColumnIndex, "Expected _editingColumnIndex equals -1 or _editingColumnIndex equals CurrentColumnIndex.");
                DiagnosticsDebug.Assert(EditingRow == null || EditingRow.Slot == CurrentSlot || DataConnection.EndingEdit, "Expected EditingRow is null or EditingRow.Slot equals CurrentSlot or DataConnection.EndingEdit is true.");
                return true;
            }

            UIElement oldDisplayedElement = null;
            DataGridCellCoordinates oldCurrentCell = new(CurrentCellCoordinates);
            ...
            if (CurrentColumnIndex > -1)
            {
                DiagnosticsDebug.Assert(CurrentSlot > -1, "Expected CurrentSlot greater than -1.");
                DiagnosticsDebug.Assert(CurrentColumnIndex < ColumnsItemsInternal.Count, "Expected CurrentColumnIndex smaller than ColumnsItemsInternal.Count.");
                DiagnosticsDebug.Assert(CurrentSlot < SlotCount, "Expected CurrentSlot smaller than SlotCount.");
                if (IsSlotVisible(CurrentSlot))
                {
        ...
        private void ShowScrollBars()
        {
            ...
            else
            {
                ...
                {
                    if (AreBothScrollBarsVisible && (_isPointerOverHorizontalScrollBar || _isPointerOverVerticalScrollBar))
                    {
                ...
                else
                {
                    ...
                    {
                        _proposedScrollBarsSeparatorState = IsEnabled ? ScrollBarsSeparatorVisualState.SeparatorExpandedWithoutAnimation : ScrollBarsSeparatorVisualState.SeparatorCollapsed;
                    }
                    else
                    {
                        _proposedScrollBarsSeparatorState = IsEnabled ? ScrollBarsSeparatorVisualState.SeparatorCollapsedWithoutAnimation : ScrollBarsSeparatorVisualState.SeparatorCollapsed;
                    }
                }
            ...
            if (_hScrollBar != null)
            {
                if (needHorizScrollBar || forceHorizScrollBar)
                {
                    ...
                    if (_hScrollBar.Visibility != Visibility.Visible)
                    {
                        ...
                        if (!IsHorizontalScrollBarOverCells && _hScrollBar.DesiredSize.Height == 0)
                        {
        ...
        {
            int placeholderSlot = SlotFromRowIndex(DataConnection.NewItemPlaceholderIndex);
            if (DataConnection.NewItemPlaceholderPosition == NewItemPlaceholderPosition.AtEnd &&
                _collapsedSlotsTable.Contains(placeholderSlot) != IsReadOnly)
            {
                if (IsReadOnly)
                {
                    if (SelectedIndex == DataConnection.NewItemPlaceholderIndex)
                    {
                        SelectedIndex = Math.Max(-1, DataConnection.Count - 2);
                    }

                    if (IsSlotVisible(SlotFromRowIndex(DataConnection.NewItemPlaceholderIndex)))
                    {
                        RemoveDisplayedElement(placeholderSlot, false, true);
        ...
        {
            if (_rowsPresenter != null && DataConnection.Count > 0)
            {
                ...
                foreach (DataGridRow row in GetAllRows())
                {
                    if (row.Visibility == Visibility.Visible)
                    {
                        if (newDetailsMode == DataGridRowDetailsVisibilityMode.VisibleWhenSelected)
                        {
                            ...
                            newDetailsVisibility = _selectedItems.ContainsSlot(row.Slot) && row.Index != DataConnection.NewItemPlaceholderIndex ? Visibility.Visible : Visibility.Collapsed;
                        }
        ...
        private bool UpdateStateOnTapped(TappedRoutedEventArgs args, int columnIndex, int slot, bool allowEdit, bool shift, bool ctrl)
        {
            ...
            if (wasInEdit && (columnIndex != EditingColumnIndex || slot != CurrentSlot) &&
                WaitForLostFocus(() => { UpdateStateOnTapped(args, columnIndex, slot, allowEdit, shift, ctrl); }))
            {
                return true;
            }
            ...
            if (_vScrollBar != null)
            {
                if (needVertScrollBar || forceVertScrollBar)
                {
                    ...
                    if (_vScrollBar.Visibility != Visibility.Visible)
                    {
                        ...
                        if (!IsVerticalScrollBarOverCells && _vScrollBar.DesiredSize.Width == 0)
                        {
        ...
        private bool ValidateEditingRow(bool scrollIntoView, bool wireEvents)
        {
            ...
            if (EditingRow != null)
            {
                ...
                if (!_initializingNewItem)
                {
                    ...
                    ValidationContext context = new(dataItem, null, null);
                ...
                foreach (DataGridColumn column in ColumnsInternal.GetDisplayedColumns(c => c.IsVisible && !c.IsReadOnly))
                {
                    if (!_initializingNewItem || column == CurrentColumn)
                    {
                        foreach (string bindingPath in column.BindingPaths)
                        {
                            ...
                            {
                                declaringPath = bindingPath[..lastIndexOfSeparator];
                                ...
                                {
                                    bindingProperty = bindingPath[(lastIndexOfSeparator + 1)..];
                                }
                            }
                        ...
                        foreach (object errorItem in errors)
                        {
                            if (errorItem != null)
                            {
                                ...
                                if (!string.IsNullOrEmpty(errorString))
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(bindingProperty))
                                    {
                                        validationResult = new ValidationResult(errorString, (string[])[bindingPath]);
                                        _propertyValidationResults.Add(validationResult);
                                    }
                                    else
                                    {
        ...
        private void ValidationItem_ErrorsChanged(object sender, DataErrorsChangedEventArgs e)
        {
            ...
            if (_validationItems.TryGetValue(indei, out string bindingPath))
            {
                DiagnosticsDebug.Assert(EditingRow != null, "Expected non-null EditingRow.");
                ...
                else if (!string.IsNullOrEmpty(e.PropertyName) && e.PropertyName.Contains(TypeHelper.LeftIndexerToken))
                {
                ...
                ValidateIndei(indei, e.PropertyName, bindingPath, null, validationResults, false /*wireEvents*/);
