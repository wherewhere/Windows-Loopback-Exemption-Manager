...
namespace CommunityToolkit.WinUI.Utilities
{
    internal static class TypeHelper
    {
        ...
        private static Type FindGenericType(Type definition, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] Type type)
        {
        ...
        private static PropertyInfo FindIndexerInMembers(MemberInfo[] members, string stringIndex, out object[] index)
        {
            ...
            foreach (PropertyInfo pi in members.OfType<PropertyInfo>())
            {
                if (pi == null)
                {
                    continue;
        ...
        internal static string GetDisplayName([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicEvents)] this Type type, string propertyPath)
        {
        ...
        internal static Type GetEnumerableItemType([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this Type enumerableType)
        {
        ...
        internal static PropertyInfo GetNestedProperty([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicEvents)] this Type parentType, string propertyPath)
        {
            if (parentType != null)
            {
                object item = null;
        ...
        [SuppressMessage("Trimming", "IL2072:Target parameter argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The return value of the source method does not have matching annotations.", Justification = "<挂起>")]
        internal static PropertyInfo GetNestedProperty([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicEvents)] this Type parentType, string propertyPath, ref object item)
        {
        ...
        internal static Type GetNestedPropertyType([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicEvents)] this Type parentType, string propertyPath)
        {
            if (parentType == null || string.IsNullOrEmpty(propertyPath))
            {
                return parentType;
        ...
        internal static PropertyInfo GetPropertyOrIndexer([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicNestedTypes | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicEvents)] this Type type, string propertyPath, out object[] index)
        {
            index = null;
            ...
            string stringIndex = propertyPath[1..^1];
        ...
        internal static bool IsEnumerableType([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this Type enumerableType)
        {
        ...
        */
        ...
        internal static string RemoveDefaultMemberName(string property)
        {
            if (!string.IsNullOrEmpty(property) && property[^1] == RightIndexerToken)
            {
                ...
                int leftIndexerToken = property.IndexOf(LeftIndexerToken);
                if (leftIndexerToken >= 0)
                {
                    return property[leftIndexerToken..];
                }
            }
        ...
        /// <param name="propertyPath">Property path</param>
        [SuppressMessage("Trimming", "IL2075:'this' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The return value of the source method does not have matching annotations.", Justification = "<挂起>")]
        ...
        internal static List<string> SplitPropertyPath(string propertyPath)
        {
            ...
            if (!string.IsNullOrEmpty(propertyPath))
            {
                ...
                for (int index = 0; index < propertyPath.Length; index++)
                {
                    ...
                    {
                        propertyPaths.Add(propertyPath[startIndex..index]);
                        startIndex = index + 1;
                    }
                    ...
                    {
                        propertyPaths.Add(propertyPath[startIndex..]);
                    }
                }
            }
