...
{
    internal partial class IndexToValueTable<T> : IEnumerable<Range<T>>
    {
        ...
        {
            Debug.Assert(n >= 0 && n < IndexCount, "Expected n between 0 and IndexCount-1, inclusive.");
        ...
        public void InsertIndexesAndValues(int startIndex, int count, T value)
        {
            ...
            int lowerRangeIndex = FindRangeIndex(startIndex);
        ...
        private void AddValuesPrivate(int startIndex, int count, T value, int? startRangeIndex)
        {
            ...
            Range<T> newRange = new(startIndex, endIndex, value);
            if (_list.Count == 0)
            {
                _list.Add(newRange);
            }
        ...
        {
            Debug.WriteLine(IndexCount + " indexes");
            foreach (Range<T> range in _list)
            {
