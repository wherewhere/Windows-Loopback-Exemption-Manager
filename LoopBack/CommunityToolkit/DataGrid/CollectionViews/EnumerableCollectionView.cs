...
namespace CommunityToolkit.WinUI.Data.Utilities
{
    ...
    /// </summary>
    internal partial class EnumerableCollectionView : CollectionView
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        protected override void ProcessCollectionChanged(NotifyCollectionChangedEventArgs args)
        {
            ...
            switch (args.Action)
            {
                ...
                case NotifyCollectionChangedAction.Remove:
                    ...
                    {
                        if (!Equals(args.OldItems[i], _snapshot[index]))
                        {
        ...
        private IgnoreViewEventsHelper IgnoreViewEvents()
        {
        ...
        private partial class IgnoreViewEventsHelper : IDisposable
        {
